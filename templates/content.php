...
switch ($layout_type) {
    ...
    default : {
            ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class("col-md-{$grid_values['home']} col-xs-{$grid_values['full']} {$grid_classes['home']}"); ?> role="main">
    ...
    case 'archive' : {
            ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class("col-md-{$grid_values['archive']} col-xs-{$grid_values['full']} {$grid_classes['archive']}"); ?> role="main">
                <div class="layout-wrapper">
                    <div class="content-wrapper">
                        <div class="col-md-12">
                            <div class="entry-header">
    ...
    case 'singular' : {
            ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class("col-md-{$grid_values['single']} col-xs-{$grid_values['full']} {$grid_classes['single']}"); ?> role="main">
                <div class="layout-wrapper">
                    <div class="content-wrapper">
    ...
    case '404' : {
            ?>
            <article id="post-404" class="<?php echo "col-md-{$grid_values['single']} col-xs-{$grid_values['full']} {$grid_classes['single']}"; ?> post-404" role="main">
                <div class="layout-wrapper">
                    <div class="content-wrapper">
                        <div class="entry-header row">
